...
adb start-server
emulator -avd nexus-5 -wipe-data -no-audio -no-boot-anim -no-window -accel on -gpu swiftshader_indirect & # run in background

adb wait-for-device shell 'while [[ -z $(getprop sys.boot_completed) ]]; do sleep 1; done;'

#TODO find a way to accept permissions from the tests
#adb shell pm grant chat.fluffy.fluffychat android.permission.POST_NOTIFICATIONS
#adb shell pm grant chat.fluffy.fluffychat android.permission.ACCESS_NOTIFICATION_POLICY
#TODO these are too many permissions, identify the relevant ones
adb shell pm grant chat.fluffy.fluffychat android.permission.ACCESS_COARSE_LOCATION
adb shell pm grant chat.fluffy.fluffychat android.permission.ACCESS_FINE_LOCATION
adb shell pm grant chat.fluffy.fluffychat android.permission.BIND_TELECOM_CONNECTION_SERVICE
adb shell pm grant chat.fluffy.fluffychat android.permission.BLUETOOTH
adb shell pm grant chat.fluffy.fluffychat android.permission.CALL_PHONE
adb shell pm grant chat.fluffy.fluffychat android.permission.CAMERA
adb shell pm grant chat.fluffy.fluffychat android.permission.FOREGROUND_SERVICE
adb shell pm grant chat.fluffy.fluffychat android.permission.INTERNET
adb shell pm grant chat.fluffy.fluffychat android.permission.MODIFY_AUDIO_SETTINGS
adb shell pm grant chat.fluffy.fluffychat android.permission.READ_EXTERNAL_STORAGE
adb shell pm grant chat.fluffy.fluffychat android.permission.READ_PHONE_STATE
adb shell pm grant chat.fluffy.fluffychat android.permission.RECORD_AUDIO
adb shell pm grant chat.fluffy.fluffychat android.permission.SYSTEM_ALERT_WINDOW
adb shell pm grant chat.fluffy.fluffychat android.permission.USE_FULL_SCREEN_INTENT
adb shell pm grant chat.fluffy.fluffychat android.permission.VIBRATE
